...
public interface ITranslationRepository
{
    ...
    public Task<Dictionary<int, Dictionary<int, Dictionary<int, string>>>> GetTranslationsAsync(CancellationToken cancellationToken = default);
    ...
    public Task SaveTranslationAsync(List<Translation> translation, CancellationToken cancellationToken = default);
    public Task SaveTranslationNameAsync(List<TranslationName> translationName, CancellationToken cancellationToken = default);
